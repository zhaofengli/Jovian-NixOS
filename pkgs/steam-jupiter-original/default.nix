...
let
  fatBootstrap = "steam_jupiter_stable_bootstrapped_20220802.1.tar.xz";
...
in steam-original.overrideAttrs (old: {
  ...
  postInstall = (old.postInstall or "") + ''
    ...
    tar xvf ${bundle} steam-jupiter-stable/${fatBootstrap} --strip-components=1
    cp ${fatBootstrap} $out/lib/steam/bootstraplinux_ubuntu12_32.tar.xz
  '';
})
